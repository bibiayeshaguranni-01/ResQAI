...
from resqai.services.disaster_data import get_current_disasters, get_current_earthquakes
...
class DataPipelineTests(unittest.TestCase):
    ...
    def test_generic_service_fetches_a_non_earthquake_disaster(self) -> None:
        records = get_current_disasters(
            url="https://example.test/wildfires.geojson",
            source="NOAA",
            disaster_type="wildfire",
            opener=lambda *args, **kwargs: FakeResponse(sample_payload()),
        )
